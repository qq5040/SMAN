...
def _add_common_args(arg_parser):
    ...
    arg_parser.add_argument('--encoder_layers', type=int, default=2, help="Maximum size of spans")
    arg_parser.add_argument('--encoder_heads', type=int, default=8, help="Maximum size of spans")
    arg_parser.add_argument('--dropout', type=float, default=0.1, help="Maximum size of spans")
    ...
    arg_parser.add_argument('--cuda_id', type=str, default='cuda:0', help="The id of  CUDA device")
