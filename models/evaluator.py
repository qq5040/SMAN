...
from models.entities import Document, Dataset, EntityType
from models.input_reader import JsonInputReader
from models.opt import jinja2
from models.sampling import EvalTensorBatch
...
class Evaluator:
    ...
    def eval_batch(self, batch_entity_clf: torch.tensor, batch_rel_clf: torch.tensor,
        ...
        for i in range(batch_size):
            ...
            # if rel_nonzero.shape != torch.Size([0]):
            #     print('lll')
